...
import { Mail, Lock, Eye, EyeOff, LogIn, User, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-primary relative flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10 mt-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">Sign in to your student portal</p>
        </div>
        ...
        {/* Demo Credentials */}
        <div className="mt-6 text-center text-white/90 bg-white/10 p-4 rounded-xl backdrop-blur-sm">
          <p className="text-sm font-semibold mb-2">Demo Account:</p>
          <p className="text-sm">Email: demo@tresbontech.com</p>
